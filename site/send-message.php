...
<body data-page="contact-result">
  ...
  <script src="js/01-nucleo.js?v=20260906224024"></script>
  <script src="js/02-slots-imagem.js?v=20260906224024"></script>
  <script src="js/03-conteudo-home.js?v=20260906224024"></script>
  <script src="js/04-funil-tracking.js?v=20260906224024"></script>
  <script src="js/05-admin-nucleo.js?v=20260906224024"></script>
  <script src="js/06-chrome-tema.js?v=20260906224024"></script>
  <script src="js/07-carrinho.js?v=20260906224024"></script>
  <script src="js/08-menu-site.js?v=20260906224024"></script>
  <script src="js/09-admin-paineis.js?v=20260906224024"></script>
  <script src="js/10-produto-precos.js?v=20260906224024"></script>
  <script src="js/11-designs-media.js?v=20260906224024"></script>
  <script src="js/12-crachas-imanes.js?v=20260906224024"></script>
  <script src="js/13-quadros-cores.js?v=20260906224024"></script>
  <script src="js/14-upload-quantidade.js?v=20260906224024"></script>
  <script src="js/15-cadernos.js?v=20260906224024"></script>
  <script src="js/16-quadros-resumo.js?v=20260906224024"></script>
  <script src="js/17-wizard-render.js?v=20260906224024"></script>
  <script src="js/18-wizard-navegacao.js?v=20260906224024"></script>
  <script src="js/19-upload-media-pedido.js?v=20260906224024"></script>
  <script src="js/20-quadros-anim-bind.js?v=20260906224024"></script>
  <script src="js/21-checkout.js?v=20260906224024"></script>
  <script src="js/22-admin-imagem.js?v=20260906224024"></script>
  <script src="js/23-arranque.js?v=20260906224024"></script>
